...
var embedImages_single_file = function(htmlFile, imageDir, existingImages) {
    // console.log("embedImages_single_file()", htmlFile, imageDir, existingImages )
...
module.exports.embedImages = function(storyDirectory) {
    ...
    var imageDir = path.join(storyDirectory, imageDirName);
    
    return fsp.ensureDir( imageDir )
        .then(function() {
            return fsp.readdir(imageDir)
        })
            ...
            return deferred.promise
                    .then( function(files) {
                        ...
                        files.forEach(function(file) {
                            embedImages_single_file_promises.push(embedImages_single_file(file, imageDir, existingImages))
                        });
